    ...
    >
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        >
          ...
          >
            <span className="text-foreground font-medium">Software Engineer</span> · CSE Student · Problem Solver
          </motion.p>
          ...
          >
            <a
              href="#projects"
              className="btn-glow px-8 py-4 rounded-xl font-semibold text-primary-foreground transition-all"
            >
              View Projects
            </a>
            <a
              href="#contact"
              className="px-8 py-4 rounded-xl font-semibold glass-card hover:bg-secondary/50 transition-all"
            >
              Get in Touch
            </a>
          </motion.div>
          ...
          >
            <a
              ...
              className="p-3 rounded-xl glass-card hover:bg-secondary/50 transition-all group"
              aria-label="GitHub"
            >
